...
import mybatis.controller.api.ApiMovieRegisterController;
...
public class RequestControllerMapping {
	...
	public static void init() {
		...
		mapping.put(new RequestKeyValue("/api/movie", "POST"), new ApiMovieRegisterController());
		/* mapping.put(new RequestKeyValue("/api/movie/modify", "PUT"), null); */
	}
